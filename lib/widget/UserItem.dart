...
class UserItem extends StatelessWidget{
  const UserItem(this.currentUser,this.onUpdateUserScreen,{super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: (){onUpdateUserScreen(currentUser);},
        child: Card(
          elevation: 2,
          child: Padding(
            ...
            child: Row(
              children: [
                Image.asset("assets/Images/imageAvatar.jpeg",width: 100,height: 100,),
                Expanded(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(currentUser.userName,style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
